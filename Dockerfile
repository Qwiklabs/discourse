...
ADD docker_add/install-imagemagick /tmp/install-imagemagick
RUN /tmp/install-imagemagick

ADD docker_add/install-jemalloc /tmp/install-jemalloc
RUN /tmp/install-jemalloc

ADD docker_add/install-nginx /tmp/install-nginx
RUN /tmp/install-nginx

ADD docker_add/install-oxipng /tmp/install-oxipng
RUN /tmp/install-oxipng

ADD docker_add/install-redis /tmp/install-redis
RUN /tmp/install-redis

ADD docker_add/install-ruby /tmp/install-ruby
...
# process
ADD docker_add/thpoff.c /src/thpoff.c
